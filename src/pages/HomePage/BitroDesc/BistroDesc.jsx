...
const BistroDesc = () => {
  return (
    <div className="bistro_box w-full h-full">
      ...
      <div
        className="w-full h-full py-24 md:py-28"
        style={{
          backgroundColor: "rgba(0, 0, 0, 0.6)",
          opacity: "1",
        }}
      >
        <div className="flex justify-center items-center h-full w-3/4 md:max-w-screen-sm lg:max-w-screen-md mx-auto ">
          <div className="text-center bg-white py-5 md:py-12 space-y-4">
